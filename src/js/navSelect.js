...
//ToDo Выпадающее окно с переворачивающейся стрелкой для мобильного меню
// document.addEventListener('DOMContentLoaded', function() {
//     const buyLink = document.getElementById('mob-buy-link');
//     const menu = document.getElementById('mob-menu');
//     const arrow = buyLink.querySelector('.mobile-menu__nav-arrow');
